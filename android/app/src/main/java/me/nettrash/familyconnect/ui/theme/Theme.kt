 ...
 * complete blue/amber brand fallback schemes below that.
 *
...
// Both fallback schemes define the full role set: leaving roles unset
// hands sheets/dialogs/FABs the baseline purple defaults, which clash
// with the blue/amber brand on < Android 12 devices.
